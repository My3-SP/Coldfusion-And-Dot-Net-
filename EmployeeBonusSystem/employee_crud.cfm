            ...
            <div class="container">
                ...
                <cfif decryptedID NEQ "">
                    <div class="employee-form">
                        ...
                        <form method="post">
                            <input type="hidden" name="EmployeeID" value="#decryptedID#">

                            <div class="form-group">
                                <label>Name</label>
                                <input type="text" name="EmployeeName" value="#cleanName#" required>
                                <cf_messageBox msg="#nameError#" type="error">
                            </div>

                            <div class="form-group">
                                <label>Department</label>
                                <input type="text" name="Department" value="#cleanDept#" required>
                                <cf_messageBox msg="#deptError#" type="error">
                            </div>

                            <div class="form-group">
                                <label>Salary</label>
                                <input type="number" name="Salary" value="#cleanSalary#" required>
                                <cf_messageBox msg="#salaryError#" type="error">
                            </div>

                            <div class="form-group">
                                <label>Rating</label>
                                <input type="number" name="Rating" value="#cleanRating#" required>
