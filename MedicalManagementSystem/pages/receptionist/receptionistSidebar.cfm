    ...
    <div class="sidebar-wrapper active">
        <div class="sidebar-header position-relative">
            <div class="d-flex justify-content-between align-items-center">
                <div class="logo">
                    <a href="/MedicalManagementSystem/pages/receptionist/dashboard.cfm"><b>MMS</b></a>
                </div>
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li
                    class="sidebar-link ">
                    <a href="/MedicalManagementSystem/pages/receptionist/appointments.cfm" class='sidebar-link'>
