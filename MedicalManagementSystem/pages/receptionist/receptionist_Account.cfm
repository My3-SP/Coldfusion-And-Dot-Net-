...
<cfset userService     = createObject("component","MedicalManagementSystem.components.ReceptionAccountService")>
...
<cfset admin = userService.getReceptionDetails(session.user.user_id)>
...
<div id="main">
    ...
    <cfoutput>
        <div class="container mt-4">
            ...
            <!--- PROFILE FORM --->
            <div class="card mb-4">
                <div class="card-body fw-semibold">Personal Details</div>
                <div class="card-body">
...
$('#updateAdminForm').on('submit', function(e){
    ...
    $.ajax({
        ...
        url:'/MedicalManagementSystem/components/ReceptionAccountService.cfc?method=updateReceptionDetailsAjax&returnformat=json',
        type:'POST',
        data:$(this).serialize(),
        dataType:'json',
