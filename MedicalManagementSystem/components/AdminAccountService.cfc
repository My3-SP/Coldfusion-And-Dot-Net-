<cfcomponent displayname="AdminAccountService">
    ...
    <!--- Get Admin Details --->
    <cffunction name="getAdminDetails" access="public" returntype="struct" output="false">
    ...
    <cffunction name="updateAdminDetailsAjax" access="remote" returntype="struct" returnformat="json" output="false">
