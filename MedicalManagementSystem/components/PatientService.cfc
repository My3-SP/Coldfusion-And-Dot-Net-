<cfcomponent displayName="PatientService" output="false">
    ...
    <!--- <cfargument name="password_raw"    type="string"  required="true"> --->
    ...
    <cfif qDuplicate.recordCount GT 0>
        ...
        <!--- Reactivate — NO cfreturn here, fall through to common section --->
    ...
    <cfelse>
        ...
        <cfmail
            ...
            Your patient portal account has been created.<br><br>
            <b>Username:</b> #usernameVal#<br>
            <b>Temporary Password:</b> #defaultPassword#<br><br>
            Login here: http://localhost/MedicalManagementSystem/login.cfm<br><br>
    ...
    <!--- COMMON RETURN VALUES — runs for BOTH new and reactivated --->
